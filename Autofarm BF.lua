...
local win = Flux:Window("August Hub", "August", Color3.fromRGB(0, 255, 255), Enum.KeyCode.RightControl)
...
tab2:Toggle("BloxFruit", "",false, function(t)
    ...
    local SelectWeapon = Players:Dropdown("Select Weapon",Weapon,function(Value)
        SelectToolWeapon = Value
    end)
    ...
    Players:Button("Teleport"," ",function(v)
        game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players:FindFirstChild(KillPlayer).Characters.HumanoidRootPart.CFrame
    end)
    
    Players:Toggle("KillPlayer", "",false, function(v)
        KillPlayer = v
    end)
    spawn(function()
        while wait() do 
